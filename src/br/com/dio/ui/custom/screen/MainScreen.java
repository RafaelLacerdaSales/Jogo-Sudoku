...
public class MainScreen {
    ...
    private List<Space> getSpacesFromSector(final List<List<Space>> space, final int initColl,final int endCol, final int initRow,final int endRow){
    ...
    private void addRestButton(JPanel mainPanel) {
       resetButton = new ResetButton(e ->{
            var dialogResult = showConfirmDialog(
                    null,
                    "Deseja realmentereiniciar o jogo?",
                    "Limpar o jogo",
                   YES_NO_OPTION,
                    QUESTION_MESSAGE
            );
